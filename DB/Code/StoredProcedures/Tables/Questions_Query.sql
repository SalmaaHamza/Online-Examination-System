...
ALTER proc spGetByIdAllQuestionsInCrs @course_id int
as
    BEGIN TRY 
...
ALTER proc spGetByIdQuestionsNoInCrs @course_id int
as
    BEGIN TRY 
...
ALTER proc spGetAllQuestionsWizAnswerInCrs @course_id int
as
    BEGIN TRY 
...
ALTER proc spGetByIdQuestionAnswer @Ques_no int
as
    BEGIN TRY 
...
--	-- 4000 In Case of Not Found (Question Number)
---- =============================================
ALTER proc spUpdateQuestionDesc  @qNo int,@newdesc nvarchar(50)
as
...
---- =============================================
ALTER proc spDeleteAllCrsQuestions @Course_ID int
as
    BEGIN TRY 
...
---- =============================================
ALTER proc spDeleteQuestionchoices @qNo int
as
    BEGIN TRY 
