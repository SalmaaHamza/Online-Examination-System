...
as
	...
	BEGIN TRY
		select Q.Ques_No,Ques_Desc,QC.Choice_Desc,Q.Model_Answer ,Answer from Exam_Ques EQ
		inner join Question Q on EQ.Ques_No = Q.Ques_No and EQ.Exam_No = 1
		inner join Ques_Choices QC on Q.Ques_No = QC.Ques_No
		inner join Std_Exam_Ques S ON S.Ques_No = eq.Ques_No
	RETURN 1000
	END TRY
